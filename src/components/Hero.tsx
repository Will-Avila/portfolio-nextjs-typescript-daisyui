...
export default function Hero() {
  return (
    <div className="container-xl mx-auto flex flex-col items-center justify-between lg:flex-row md:gap-8">
        ...
        <div className="flex flex-col md:flex-row items-center justify-center gap-4 md:justify-between">
          ...
          <div className="flex gap-4">
            <Link
              ...
              href="https://www.linkedin.com/in/will-avila"
              target="_blank"
              title="Ir para o Linkedin"
              data-tip="Ir para o Linkedin"
            >
              <FaLinkedin
      ...
      <motion.img
        className="bottom-0 max-size-3/5  sm:pt-8"
        initial={{ opacity: 0 }}
